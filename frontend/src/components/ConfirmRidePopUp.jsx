            ...
            <div className='flex flex-col gap-2 justify-between items-center'>
                ...
                <div className='mt-6 w-full'>
                    <form onSubmit={(e) => {
                        ...
                        <Link to='/captain-riding' className='mt-5 w-full flex justify-center bg-green-600 text-white text-lg font-semibold p-3 rounded-lg'>Confirm</Link>

                        <button onClick={() => {
                            props.setConfirmRidePopupPanel(false)
                            props.setRidePopupPanel(false)
                        }} className='mt-1 w-full bg-red-600 text-white text-lg font-semibold p-3 rounded-lg'>Cancel</button>
